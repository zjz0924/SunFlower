...
public class CookieUtils {
    ...
    //支付方式
    public static final String PAY_TYPE = "PAY_TYPE_COOKIE_NAME_";
    //取票方式
    public static final String TICKET_WAY = "TICKET_WAY_COOKIE_NAME_";
    //订单类型
    public static final String SALE_TYPE = "SALE_TYPE_COOKIE_NAME_";
