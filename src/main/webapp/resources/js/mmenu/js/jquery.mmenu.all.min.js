    ...
    function n() {
        ...
        function(e, n) {
            n.add = function(e) {
                e = e.split(" ");
                for (var t = 0,
                s = e.length; t < s; t++) n[e[t]] = n.mm(e[t])
            }
        }), i.mm = function(e) {
            return "mm-" + e
        },
        ...
        e[t].prototype = {
            ...
            openPanel: function(n) {
                ...
                if (s.hasClass(i.vertical)) {
                    ...
                    n.hasClass(i.opened) ? n.nextAll("." + i.opened).addClass(i.highest).removeClass(i.opened).removeClass(i.subopened) : (n.addClass(i.highest), l.addClass(i.subopened)),
            ...
            trigger: function() {
                ...
                t = n.shift();
                if (t = "init" == t ? "initPanels": t, this.cbck[t]) for (var s = 0,
                i = this.cbck[t].length; s < i; s++) this.cbck[t][s].apply(e, n)
            },
            _initMenu: function() {
            ...
            _initPanels: function(n) {
                ...
                l.each(function() {
                    ...
                    n.hasClass(i.vertical) && (n.removeClass(t.conf.classNames.vertical), s.add(s.parent()).addClass(i.vertical)),
                    r = r.add(s)
                });
...
function(e) {
    ...
    e[n].prototype["_initWindow_" + t] = function() {
        o.$wndw.off(a.keydown + "-" + t).on(a.keydown + "-" + t,
        function(e) {
            if (o.$html.hasClass(s.opened) && 9 == e.keyCode) return e.preventDefault(),
            !1
        });
        var e = 0;
        o.$wndw.off(a.resize + "-" + t).on(a.resize + "-" + t,
        function(n, t) {
            if (1 == o.$page.length && (t || o.$html.hasClass(s.opened))) {
                var i = o.$wndw.height(); (t || i != e) && (e = i, o.$page.css("minHeight", i))
            }
        })
    },
    e[n].prototype._initBlocker = function() {
        var n = this;
        this.opts[t].blockUI && (o.$blck || (o.$blck = e('<div id="' + s.blocker + '" class="' + s.slideout + '" />')), o.$blck.appendTo(o.$body).off(a.touchstart + "-" + t + " " + a.touchmove + "-" + t).on(a.touchstart + "-" + t + " " + a.touchmove + "-" + t,
        function(e) {
            e.preventDefault(),
            e.stopPropagation(),
            o.$blck.trigger(a.mousedown + "-" + t)
        }).off(a.mousedown + "-" + t).on(a.mousedown + "-" + t,
        function(e) {
            e.preventDefault(),
            o.$html.hasClass(s.modal) || (n.closeAllOthers(), n.close())
        }))
    };
    var s, i, a, o
} (jQuery),
    ...
    e[n].addons[t] = {
        setup: function() {
            ...
            if (o = e[n].glbl, e[n].support.touch && this.opts.offCanvas && this.opts.offCanvas.blockUI && ("boolean" == typeof r && (r = {
                fix: r
            }), "object" != typeof r && (r = {}), r = this.opts[t] = e.extend(!0, {},
            e[n].defaults[t], r), r.fix)) {
                ...
                o.$docu.on(a.touchmove,
                function(e) {
                    i.vars.opened && e.preventDefault()
                }),
                o.$body.on(a.touchstart, "#" + l + "> ." + s.panels + "> ." + s.current,
                function(e) {
                    i.vars.opened && (d || (d = !0, 0 === e.currentTarget.scrollTop ? e.currentTarget.scrollTop = 1 : e.currentTarget.scrollHeight === e.currentTarget.scrollTop + e.currentTarget.offsetHeight && (e.currentTarget.scrollTop -= 1), d = !1))
                }).on(a.touchmove, "#" + l + "> ." + s.panels + "> ." + s.current,
                function(n) {
                    i.vars.opened && e(this)[0].scrollHeight > e(this).innerHeight() && n.stopPropagation()
                }),
                o.$wndw.on(a.orientationchange,
                function() {
        ...
        setup: function() {
            if (this.opts.offCanvas) {
                ...
                if (o = e[n].glbl, "boolean" == typeof i && i && (i = {
                    ...
                    height: i
                }), "object" != typeof i && (i = {}), i = this.opts[t] = e.extend(!0, {},
                e[n].defaults[t], i), "auto" == i.height || "highest" == i.height) {
                    ...
                    var a = function(n) {
                        if (this.vars.opened) {
                            ...
                            "auto" == i.height ? (n = n || this.$pnls.children("." + s.current), n.is("." + s.vertical) && (n = n.parents("." + s.panel).not("." + s.vertical).first()), o = n.outerHeight()) : "highest" == i.height && this.$pnls.children().each(function() {
                                var n = e(this);
                    ...
                    "auto" == i.height && (this.bind("update", a), this.bind("openPanel", a), this.bind("closePanel", a))
                }
            }
        },
        add: function() {
...
function(e) {
    ...
    e[n].addons[t] = {
        setup: function() {
            ...
            }), r.collapse && this.bind("initPanels",
            function(n) {
                ...
                function(n) {
                    n.off(a.scroll + "-dividers " + a.touchmove + "-dividers").on(a.scroll + "-dividers " + a.touchmove + "-dividers",
                    function(n) {
                        l.call(i, e(this))
                    })
                })
...
function(e) {
    ...
    function t(t, s, i) {
        ...
        function(e) {
            2 == p && (i.$html.removeClass(o.dragging), i.$slideOutNodes.css("transform", ""), u[v == f.open_dir ? "_openFinish": "close"]()),
            p = 0
        })
    }
    function s(n, t, s, i) {
    ...
    e[i].addons[a] = {
        setup: function() {
            if (this.opts.offCanvas) {
                ...
                n.panels.close && this.bind("initPanels",
                function(e) {
                ...
                e[n].defaults[t], l), l.drop) {
                    ...
                    if ("string" == typeof l.position.of) {
                        ...
                        if (h.length) {
                            ...
                            "hover" == l.event[0] && h.on(a.mouseenter + "-dropdown",
                            function() {
                                r.open()
                            }),
                            "hover" == l.event[1] && this.$menu.on(a.mouseleave + "-dropdown",
                            function() {
                                r.close()
                            }),
                            this.bind("opening",
                            ...
                            var u = function(i, a) {
                                ...
                                var x, k;
                                return "after" == g ? (x = "x" == i ? C: $, k = y - (x + w), r[p] = x + d.offset.button[i], r[v] = "auto", c.push(s["x" == i ? "tipleft": "tiptop"])) : (x = "x" == i ? $: C, k = x - w, r[v] = "calc( 100% - " + (x - d.offset.button[i]) + "px )", r[p] = "auto", c.push(s["x" == i ? "tipright": "tipbottom"])),
                            ...
                            this.bind("opening", f),
                            o.$wndw.on(a.resize + "-dropdown",
                            function(e) {
                                f.call(r)
                            }),
                            this.opts.offCanvas.blockUI || o.$wndw.on(a.scroll + "-dropdown",
                            function(e) {
                                f.call(r)
                            })
                        }
...
function(e) {
    function n(n, t) {
        ...
        var s = e();
        "default" == t && (s = n.children("." + a.listview).find("a[href]").not(":hidden"), s.length || (s = n.find(d).not(":hidden")), s.length || (s = this.$menu.children("." + a.navbar).find(d).not(":hidden"))),
    ...
    e[s].addons[i] = {
        setup: function() {
            ...
            if (l = e[s].glbl, "boolean" != typeof r && "string" != typeof r || (r = {
                enable: r
            }), "object" != typeof r && (r = {}), r = this.opts[i] = e.extend(!0, {},
            e[s].defaults[i], r), r.enable) {
    ...
    e[s].prototype["_initWindow_" + i] = function(n) {
        ...
        l.$wndw.off(r.focusin + "-" + i).on(r.focusin + "-" + i,
        function(n) {
        ...
        l.$wndw.off(r.keydown + "-" + i).on(r.keydown + "-" + i,
        function(n) {
            var t = e(n.target),
            s = t.closest("." + a.menu);
            if (s.length) {
    ...
    e[n].addons[t][s] = function(s, i) {
        ...
        var r, l, d = function(e) {
            if (e = e || this.$pnls.children("." + a.current), !e.hasClass(a.vertical)) {
                ...
                o[_owns ? "attr": "removeAttr"]("aria-owns", _owns),
    ...
    e[s].addons[i] = {
        setup: function() {
            ...
            e[s].defaults[i], o), o.aria) {
                ...
                this.bind("openPanel", u);
                var f = function(t) {
                    n(t.find("." + a.prev + ", ." + a.next), "haspopup", !0),
                    n(t.find("." + a.next).next("span"), "hidden", !0),
                    t.find("." + a.prev + ", ." + a.next).each(function() {
                        $o = e(this).attr("href").replace("#", ""),
                        n(e(this), "owns", $o)
                    })
                };
            ...
            if (o.text) {
                var p = function(s) {
                    s.children("." + a.navbar).children("." + a.prev).each(function() {
                        $n = e(this).next("a"),
                        e(this).html(t($n.text() + r.text.closeSubmenu))
                    }),
                    ...
                    s.children("." + a.listview).children("." + a.next).each(function() {
                        $n = e(this).next("span"),
                        e(this).html(t($n.text() + r.text.openSubmenu))
                    }),
                    ...
                    s.is("." + a.panel) && s.find("." + a.listview).find("." + a.next).each(function() {
                        $n = e(this).next("span"),
                        e(this).html(t($n.text() + r.text[e(this).parent().is("." + a.vertical) ? "toggleSubmenu": "openSubmenu"]))
                    })
                };
...
function(e) {
    ...
    e[t].addons[s] = {
        setup: function() {
            ...
            e[t].defaults[s], d),
            c = this.conf[s] = e.extend(!0, {},
            e[t].configuration[s], c),
            this.bind("close",
            function() {
                    ...
                    if (r.each(function() {
                        ...
                        if (!n.is("." + i.panel) || !n.is("." + i.vertical)) {
                            if (!n.children("." + i.search).length) {
                                ...
                                if (t && e('<a class="' + i.btn + " " + i.clear + '" href="#" />').appendTo(h).on(o.click + "-searchfield",
                                function(e) {
                                    e.preventDefault(),
                                    u.val("").trigger(o.keyup + "-searchfield")
                                }), s) {
                                    for (f in s) h.attr(f, s[f]);
                                    r && !t && e('<a class="' + i.btn + " " + i.next + '" href="#" />').appendTo(h).on(o.click + "-searchfield",
                                    function(e) {
                                        e.preventDefault(),
                                        h.submit()
                                    })
                        ...
                        this.$menu.find("." + i.search).each(function() {
                            ...
                            u ? (t = c.closest("." + i.panel), r = t) : (t = e("." + i.panel, l.$menu), r = l.$menu),
                            ...
                            C = function() {
                                ...
                                if (n != _) {
                                    if (_ = n, d.resultsPanel.add && h.children("." + i.listview).empty(), t.scrollTop(0), m.add(v).addClass(i.hidden).find("." + i.fullsubopensearch).removeClass(i.fullsubopen + " " + i.fullsubopensearch), m.each(function() {
                                        var n = e(this),
                                        t = b; (d.showTextItems || d.showSubPanels && n.find("." + i.next)) && (t = g);
                            ...
                            f.off(o.keyup + "-" + s + " " + o.change + "-" + s).on(o.keyup + "-" + s,
                            function(e) {
        ...
        setup: function() {
            ...
            function(n) {
                ...
                if (!this.$indexer && this.$pnls.children("." + s.hasindexer).length) {
                    ...
                    this.$indexer.children().on(a.mouseover + "-sectionindexer " + s.touchstart + "-sectionindexer",
                    function(n) {
...
function(e) {
    ...
    e[n].addons[t] = {
        setup: function() {
            ...
            } else r.current || this.bind("initPanels",
            function(e) {
